...
export const Inicio = () => {
  return (
    <section
      id='inicio'
      className='mt-20 flex justify-center items-center flex-col text-center p-5 min-h-max gap-6 font-bold
    '
    >
      ...
      <p className='text-xl xl:text-2xl font-normal md:w-2/4'>
        Soy un estudiante de la carrera de Ingeniería de Sistemas Informáticos,
        me apasiona el desarrollo web y estar al día con las tecnologías tanto
        para fronted y backend
      </p>
      <section>
        <a
